...
(function () {
   ...
   */
    ...
    */
      ...
      $('#dinamic-art').append("<article class='art'> <h2 class='title"+i+"'>"+data.article[i].title+"</h2> <img src='"+data.article[i].img+"'> <p class='descr"+i+"'>"+data.article[i].descr+"</p> </article>");
    }*/
				loadArticle(data);
			});
		};

		var loadArticle = function loadArticle(data) {
